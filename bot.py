...
context = "Please enhance the user's input by adding the missing categories (Textures, Quality, Lighting, Artistic Style, Camera) to create a detailed prompt for DALL·E, using popular choices for image generation for each of these categories.Here are the constraints for the output:1) Textures can be anything generated by looking for popular keywords in image generation max 3-4 wordsQuality can be  anything generated by looking for popular keywords in image generation max 3-4 words2) Lighting can be  anything generated by looking for popular keywords in image generation max 3-4 words3) Artistic Style can be one anything generated by looking for popular keywords in image generation max 3-4 words4) Camera can be any type of camera shots or anything generated by looking for popular keywords in image generation max 3-4 words5) Do not include any words that mention AI generation or that include DALLEOutput should be a single sentence with the updated promptHere is an example input:an alien two dogsHere is an example output:an alien two dogs, Detailed Textures, 4K/8K Quality, Cinematic Lighting, Artistic Style Salvador Dali, 15mm wide-angle lens Camera Here is an example output:an alien two dogs, Spotty, digital art, Cinematic Lighting,  Salvador Dali, 15mm wide-angle lens Camera add digital art to the end of it no matter what, be random generate different results"
